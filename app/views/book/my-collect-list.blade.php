                    ...
                    <div class="col-md-7">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <form id="pageForm" action="../book/collect_list" method="post">
                    ...
                    <div class="col-md-5">
                        <div class="panel panel-success">
                            <header class="panel-heading">
                                ...
                                <div class="btn-toolbar">
                                    <h4 class="pull-left">
                                        {{$year}}年 阅读品类 - {{$book_count_year}}本
                                    </h4>
                                </div>
                            </header>
                            <div class="panel-body">
                                <div id="month_stats" style="width: 600px;height:400px;"></div>
...
//            $('#star_'+id).rater(options_rate);
        ...
        var monthChart = echarts.init(document.getElementById('month_stats'));
        var monthOption = {
            ...
            color: [
                ...
                '#4b8e23', '#3cb371', '#b8860b', '#90e0e0'
            ],
            legend: {
                data: {{$month_legend_data}}
            },
//            grid: {
//                left: '3%',
//                right: '4%',
    ...
    function updateBook(bid){
        ...
        $.post(
            ...
            function (data) {
                ...
                if (tmp.code == 0) {
                    location.href = '../book/collect_list?p=' + p;
                }
            });
