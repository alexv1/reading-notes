                    ...
                    <div class="col-md-8">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <form id="pageForm" action="../search/category_2" method="post">
...
//            $('#star_'+id).rater(options_rate);
        ...
        $('#categoryTree').on('selected', function (evt, data) {
            ...
            if(data.info[0].type == "folder"){
                location.href = '../search/category_2?sid=' + id;
            }
        });
    ...
    function updateBook(bid){
        ...
        $.post(
            ...
            function (data) {
                ...
                if (tmp.code == 0) {
                    location.href = '../search/category_2?sid={{$sid}}&p={{$page}}';
                }
            });
